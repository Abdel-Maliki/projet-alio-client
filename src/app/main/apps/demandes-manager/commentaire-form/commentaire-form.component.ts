...
export class FormCommentaireComponent {
     ...
     */
    constructor(
        public matDialogRef: MatDialogRef<FormCommentaireComponent>,
        ...
        if (this.action === 'edit') {
            this.dialogTitle = 'Etat et Commentaire';
