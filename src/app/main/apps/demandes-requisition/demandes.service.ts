...
export class DemandesService implements Resolve<any>
{
    ...
    getDemandes(): Promise<any> {
        return new Promise((resolve, reject) => {
            ...
            console.log(environment.addressIp+'/api/demandes-employe/demandeurs/'+this.usersService.userData.id)
            this._httpClient.get(environment.addressIp+'/api/demandes-employe/demandeurs/'+this.usersService.userData.id)
