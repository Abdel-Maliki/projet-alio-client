        ...
        if (demande.typeDemande) {
            switch (demande.typeDemande.nom) {
                case 'Demande de conge':
                    impression.generationDemandeConge(demande);
                    break;

                case 'Requisition (Employee-Manager)':
                    impression.generationDemandeRequisition(demande);
                    break;

                case 'Requisition (Manager-Directeur)':
                    impression.generationDemandeRequisitionManager(demande);
                    break;

                case 'Target SIP':
                    impression.generationDemandeTargetSIP(demande);
                    break;

                case 'Target Bdev':
                    impression.generationDemandeTargetBdev(demande);
                    break;

                case 'Demande de contrat':
                    impression.generationDemandeContrat(demande);
                    break;

                case 'Device Promoters':
                    impression.generationDemandeDevicePromoters(demande);
                    break;

                case 'Fiche de creation CUG':
                    impression.generationFicheCreationCUG(demande);
                    break;

                case 'Purchase Request':
                    impression.generationPurchaseRequest(demande);
                    break;

                case 'Service Request Form':
                    impression.generationServiceRequestForm(demande);
                    break;


                case 'User ID Access Request Form ':
                    impression.generationUserIdAccess(demande);
                    break;
