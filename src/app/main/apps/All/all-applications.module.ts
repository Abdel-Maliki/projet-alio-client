...
import {
    ...
    MatOptionModule,
    MatSelectModule,
    MatTabsModule, MatAutocompleteModule, MatAutocomplete, MatCard, MatCardModule, MatCardActions, MatCardAvatar, MatCardHeader, MatCardContent, MatSpinner, MatDialogModule
